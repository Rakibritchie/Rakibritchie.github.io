...
function map() {
    ...
    if ($('#' + mapId).length > 0) {
        ...
        if (mapMarker) {
            ...
            marker.bindPopup("<div class='p-4'><h5>Yay ! You almost located me ! </h5><p>Muruga Pillai St. , Shivajinagar,Bangalore -560001 .Dial me on 7076820213</p></div>", {
                minwidth: 200,
                maxWidth: 600,
